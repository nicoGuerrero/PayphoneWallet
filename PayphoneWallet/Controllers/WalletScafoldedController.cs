...
namespace PayphoneWallet.Controllers
{
    ...
    [ApiController]
    public class WalletScafoldedController : ControllerBase
    {
        private readonly ApplicationDbContext _context;

        public WalletScafoldedController(ApplicationDbContext context)
        {
            _context = context;
        }

        // GET: api/WalletScafolded
        [HttpGet]
